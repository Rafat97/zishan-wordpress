...
if (wc_deposits_woocommerce_is_active()) :
    ...
    class WC_Deposits
    {
        ...
        {
            define('WC_DEPOSITS_VERSION', '4.1.14');
        ...
        {
            if (apply_filters('wcdp_declare_hpos_compatibility',false) && class_exists(\Automattic\WooCommerce\Utilities\FeaturesUtil::class)) {
